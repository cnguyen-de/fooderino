    ...
    <NuxtLayout name="list">
      <div
              ...
              <InventoryList
                :items="
                  getFilteredInventoryItems
                    ...
                    .sort(
                      (a, b) => new Date(b.last_updated) - new Date(a.last_updated) || a.name.localeCompare(b?.name)
                    )
                "></InventoryList>
            </CollapsibleContent>
          </Collapsible>
        ...
        <div
          ...
          <CreateNewItem class="w-full" location="New Category">Add item to a new category</CreateNewItem>
        </div>
      </div>
